            ...
            <div className="col-12 mt-5">
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <input className="form-control" type="number" name="taxaAposta" id="taxaAposta" required value={aposta.taxaAposta} onChange={handleChangeInput} placeholder="-- Taxa da Aposta --" />
                    </div>
